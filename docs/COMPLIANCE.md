...
2. **Dependabot is enabled** via [`.github/dependabot.yml`](../.github/dependabot.yml)
   ...
   [Dependency remediation SLA](#dependency-remediation-sla) below. — _A.8.8, A03_
3. **Enable your hosting provider's WAF and DDoS protection.** — _CC6.6_
...
7. **Verify security headers** with the Mozilla Observatory / SecurityHeaders.com
   after each deploy. — _A.5, A.8.23_
8. **Document your own incident-response runbook** referencing the SLAs in
   `SECURITY.md`. — _CC7.3 – 7.5, ISO A.5.24–5.28_
...
review date no more than 30 days out. — _ISO/IEC 27001 A.8.8, SOC 2 CC7.1,
OWASP A06:2021._
