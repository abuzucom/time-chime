...
import { PRE_HYDRATION_SCRIPT, PRE_HYDRATION_SCRIPT_CSP_SOURCE } from "@/lib/http/pre-hydration";
      ...
      <div className="w-full max-w-lg">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The page you're looking for doesn't exist, has been moved, or was never here. Try one of
            the links below.
          </p>
        </div>
